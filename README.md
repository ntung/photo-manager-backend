...
All fixable violations are resolved and committed as PM-18. Remaining violations in the scanner output are structural (too-many-lines, too-many-locals, too-many-branches, too-many-statements in app.py) and environment-specific (E0401 import errors in test.py due to path), which require major refactoring rather than mechanical fixes.
...
[2] [Storing a large number of images](https://stackoverflow.com/questions/446358/storing-a-large-number-of-images)
